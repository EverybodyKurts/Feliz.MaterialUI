...
module AutocompleteHelpers =
  ...
  let createFilterOptions (config: CreateFilterOptionsOptions<'option>) : Func<'option [], AutocompleteFilterOptionsState, 'option []> =
...
type Autocomplete =
  ...
  static member createFilterOptions<'option>
      ...
      =
    let opts = jsOptions<CreateFilterOptionsOptions<'option>>(fun o ->
